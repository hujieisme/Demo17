...
void ImageViewer::initToolBar(){
    ...
    QToolBar *operateToolBar = addToolBar(tr("操作栏"));
...
//    fileToolBar->setMovable(false);//禁止工具栏拖动
    ...
    QAction *cropAct = new QAction(cropIcon, tr("&裁剪"), this);
    ...
    QAction *rotateAct = new QAction(rotateIcon, tr("&旋转"), this);
    ...
    QAction *sortAct = new QAction(sortIcon, tr("&标签"), this);
